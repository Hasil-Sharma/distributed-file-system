...
bool dfc_command_builder(char*, const char*, file_attr_struct*, user_struct*, int);
void dfc_command_exec(int*, char*, int, file_attr_struct*, int, dfc_conf_struct*);
...
bool create_dfc_to_dfs_connections(int*, dfc_conf_struct*);
...
void tear_dfc_to_dfs_connections(int*, dfc_conf_struct*);
